...
\begin{frame}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \node[scale=0.5,gray,opacity=0.5] (user-0) at (-6,-2.5) {\mytree};
            \node[scale=0.5,gray,opacity=0.5] (user-1) at (-2,-2.5) {\mytree};
            \node[scale=0.5,gray,opacity=0.5] (user-2) at (2,-2.5) {\mytree};
            \node[scale=0.5,gray,opacity=0.5] (user-3) at (6,-2.5) {\mytree};
            ...
            \node<2->[draw,rounded corners=1em,red,above=1em of user-0,inner sep=1em] (feature-a) {Feature A};

            \draw<2->[->,red] (feature-a.east) -- (server);
        \end{tikzpicture}
    \end{center}
\end{frame}
