...
\begin{document}
    ...
    \begin{task}{Kollaboratives Arbeiten mit FOPBot}
        ...
        \begin{subtask*}[points=0]{Alles hat einen Anfang} Erstellen Sie eine Neue FOPBot-Welt mit der Weltgröße 9x9 und platzieren Sie
            ...
            Implementieren Sie nun eine Methode \inlinejava{worldOutline()}, die den Roboter einmal im Uhrzeigersinn um die Welt laufen lässt
        ...
        \begin{subtask*}[points=0]{Issues}
            Ihnen fällt auf, dass das Drehen des Roboters mühsam ist, da eine Rechtsdrehung drei Aufrufe der Methode \inlinejava{turnLeft()}
            benötigt.
        ...
        \begin{subtask*}[points=0]{Feature-Branches}
            ...
            Erstellen Sie nun einen feature-Branch und implementieren Sie die Methode \inlinejava{rotateTo(Direction direction)}.
